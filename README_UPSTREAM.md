...
> **This is the upstream DeepTutor README**, preserved in this fork for reference.  
> For **this fork's** overview and quick start, see **[README.md](README.md)** and **[SECONDARY_DEV.md](SECONDARY_DEV.md)**.  
> Official repo: [HKUDS/DeepTutor](https://github.com/HKUDS/DeepTutor).
